  ...
  return (
    <div>
      ...
      <section className="flex flex-col">
        <nav className="grid grid-cols-3 gap-3 p-2 shadow-2xl bg-black xl:grid-cols-4 2xl:grid-cols-5 xl:gap-5">
          {gamesCategories.map((categorie) => (
            <NavLink
              className="bg-black text-white flex items-center justify-center text-center h-8 text-sm xl:text-lg"
